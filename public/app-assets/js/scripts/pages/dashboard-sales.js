/*=========================================================================================
    ...
    var ctx4 = document.getElementById("earning-chart1").getContext("2d");
    ...
    // Create the chart
    var earningChart = new Chart(ctx4, earningConfig);

  var ctx5 = document.getElementById("earning-chart2").getContext("2d");
    ...
    // Create the chart
    var earningChart = new Chart(ctx5, earningConfig);
    

   var ctx6 = document.getElementById("earning-chart3").getContext("2d");
    ...
    // Create the chart
    var earningChart = new Chart(ctx6, earningConfig);
