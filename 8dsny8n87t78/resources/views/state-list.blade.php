...
<div class="content-wrapper">
  <div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
      <h3 class="content-header-title mb-0 d-inline-block"> {{strtoUpper(trans('constants.state'))}}  {{strtoUpper(trans('constants.list'))}}</h3>
        ...
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
              <a href="#">{{trans('constants.state')}} {{strtoLower(trans('constants.list'))}} </a>
            </li>
          </ol>
        </div>
      </div>
                ...
                <div class="heading-elements">
                 <ul class="list-inline mb-0">
                  ...
                  <li><a data-action="expand"><i class="ft-maximize"></i></a></li>
                     ...
                     <li @if(auth()->user()->role==3 && !in_array(12,(array)$cityAccess)) style="display:none" @endif> <button class="btn btn-primary btn-sm"><i class="ft-plus white"></i><a style=" color: white !important;" href="{{url('/')}}/admin/add_state"> {{trans('constants.add')}} {{trans('constants.state')}}</a></button></li>
               </ul>
              </div>
                ...
                <table class="table table-striped table-bordered zero-configuration">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td @if(auth()->user()->role==3 && !in_array(13,(array)$cityAccess)) style="display:none" @endif><button class="btn btn-success btn-sm"><a style=" color: white !important;" href="{{URL('/')}}/admin/edit_state/{{$d->id}}"><i class="ft-edit white"></i></a></button>
                    ...
                    <div class="modal animated slideInRight text-left" id="{{$d->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel76" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <h4 class="modal-title" id="myModalLabel76">Delete State</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form method="post" action="{{url('/')}}/admin/delete_state">
                            <div class="modal-body">
                              
                              <input type="hidden" name="_token" value="{{csrf_token()}}">
                              <input type="hidden" name="id" value="{{$d->id}}">
                              <div class="form-group">
                                <label for="eventName2">Are you sure to delete State : {{$d->state}}
                                <br>Some City, Area, Restaurants, Food Items and Orders are based on this State will also be deleted. 
                                </label>
                              </div>
                            </div>
