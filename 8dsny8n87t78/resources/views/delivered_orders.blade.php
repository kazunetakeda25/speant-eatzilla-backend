 ...
 <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">DELIVERED ORDERS</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">DASHBOARD</a>
                </li>
                <li class="breadcrumb-item"><a href="#">DELIVERED ORDERS</a>
                </li>
                      ...
                      <thead> 
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$order->res_phone}}</td>
                            <td>{{$order->driver_phone}}</td>
                           
                            <td>
                          
                           <button class="btn btn-primary btn-sm"><i class="ft-edit"></i><a style=" color: white !important;" href="{{URL('/')}}/admin/view_areas/{{$order->id}}"> View</a></button>
                             </td>
